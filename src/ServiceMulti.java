    ...
    private void afficheMessageClient(String msg) {
        ...
        switch (messArray[0]) {
            ...
            case "FANT":
                x = messArray[1];
                y = messArray[2];
                System.out.println("\t" + "Un fantôme est maintenant à la position x : " + x + " et y : " + y);
                break;
            ...
            case "SCOR":
                ...
                x = messArray[3];
                y = messArray[4];
                System.out.println("\t" + "Un fantôme fut attrapé par " + id + " à la pos x : " + x + " y : " + y + ". " + id + " est maintenant à " + p + " points.");
                break;
            ...
            case "END":
                ...
                System.out.println("\t" + "Quitter par faire n'importe quoi");
                break;
